...
ZONES = [
    {
        ...
        'pages': [
            ...
            _page('suivi_bp.historique_modifications', 'Historique des modifications',
                  profils=('directeur',),
                  mots='journal changement modification audit trace'),
            _page('suivi_bp.suivi_anomalies', 'Suivi des anomalies',
                  profils=('directeur', 'comptable'),
                  mots='erreur incoherence fiche heure anomalie corriger'),
            _page('suivi_bp.alertes_surcharge', 'Alertes de surcharge',
                  profils=('directeur', 'comptable'),
                  mots='charge travail prevention amplitude repos alerte'),
    ...
    },
    {
        ...
        'pages': [
            _page('saisie_bp.saisie_heures', 'Saisir mes heures',
                  ...
                  mots='heure temps pointage saisie travail fiche',
            ...
            _page('forfait_bp.dashboard_forfait_jour', 'Forfait jour',
                  profils=('directeur',),
                  mots='forfait jour jours travaille repos 210'),
    ...
    },
    {
        ...
        'pages': [
            ...
            _page('generation_contrats_bp.generation_contrats', 'Génération de contrats',
                  profils=('directeur', 'comptable'),
                  mots='contrat modele document creer rediger embauche cdd cdi'),
            _page('generation_contrats_bp.generation_contrats', 'Génération de contrats',
                  profils=('responsable',),
            ...
            _page('rh_statistiques_bp.rh_statistiques', 'Statistiques RH',
                  profils=('directeur', 'comptable'),
                  mots='rh statistique effectif etp anciennete age contrat absent'),
    ...
    },
    {
        ...
        'pages': [
            ...
            _page('regles_comptables_bp.liste_regles', 'Règles comptables',
                  profils=('directeur', 'comptable'),
                  mots='regle comptable automatisation imputation compte analytique ia'),
    ...
    },
    {
        ...
        'pages': [
            _page('accueil_bp.mon_espace', 'Mes compteurs',
                  ...
                  mots='moi solde compteur conge cp recuperation recup demande personnel',
                  expressions=('mes congés', 'mon solde de congés',
    ...
    },
    {
        ...
        'pages': [
            _page('admin_bp.gestion_users', 'Utilisateurs',
                  profils=('directeur', 'comptable'),
                  mots='utilisateur compte login profil droit acces mot passe salarie'),

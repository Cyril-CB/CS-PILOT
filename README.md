...
Le numero de version suit le format `1.1.XXXX` ou `XXXX` correspond a la derniere migration de base de donnees appliquee. La version est calculee automatiquement et affichee sur la page Administration et dans le pied de page.

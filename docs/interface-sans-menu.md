...
Les fiches suivent **Salarié → Responsable → Direction**. Une action de validation
n'est proposée qu'à l'étape de son lecteur. La direction et la comptabilité
suivent aussi l'attente des acteurs précédents, avec un libellé explicite.
Une modification du contenu rend les anciennes approbations obsolètes et renvoie
la fiche au salarié ; les références d'instantanés, et non les dates du journal,
déterminent l'accord courant. La relance groupée cible l'acteur réellement attendu.

Les anciennes fiches verrouillées restent clôturées. Leur confirmation salarié
souhaitée apparaît séparément, sans urgence ni blocage du mois courant. Voir
[le circuit des fiches mensuelles](fiches-mensuelles.md) pour la bascule, les
doubles rôles et les confirmations tardives.

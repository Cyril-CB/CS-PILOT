...
# Garder la date d'introduction : une vieille sauvegarde ne requiert pas les
# futurs modules. Une table ajoutée doit être inscrite ici dans la même PR.
TABLES_REQUISES = {
    '0001': ('users', 'secteurs', 'heures_reelles', 'planning_theorique', 'validations',
             'app_settings', 'demandes_recup', 'historique_modifications', 'alternance_reference',
             'anomalies', 'jours_feries', 'periodes_vacances', 'planning_enfance_config',
             'presence_forfait_jour', 'validation_forfait_jour'),
    '0003': ('absences',),
    '0004': ('variables_paie', 'variables_paie_defauts'),
    '0005': ('contrats', 'documents_salaries'),
    '0006': ('prepa_paie_statut',),
    '0008': ('conges_cloture_mensuelle',),
    '0009': ('postes_alisfa',),
    '0012': ('budgets', 'budget_lignes', 'postes_depense', 'postes_depense_secteur_types'),
    '0013': ('budget_reel_lignes',),
    '0014': ('frequentation_creche',),
    '0016': ('subventions', 'subventions_sous_elements', 'subventions_analytiques'),
    '0017': ('benevoles',),
    '0018': ('salles', 'recurrences_salles', 'reservations_salles'),
    '0019': ('tresorerie_comptes', 'tresorerie_donnees', 'tresorerie_imports',
             'tresorerie_solde_initial', 'tresorerie_budget_n'),
    '0021': ('tresorerie_epargne_mouvements', 'tresorerie_epargne_solde'),
    '0022': ('factures', 'ecritures_comptables', 'facture_historique', 'facture_commentaires',
             'fournisseurs', 'regles_comptables'),
    '0023': ('archives_export',),
    '0024': ('modeles_contrats', 'contrats_generes', 'lieux_travail', 'forfaits_cee'),
    '0026': ('comptabilite_actions', 'comptabilite_comptes', 'bilan_fec_donnees',
             'bilan_fec_imports', 'bilan_taux_logistique'),
    '0027': ('types_secteur',),
    '0028': ('alsh_config_codes', 'alsh_periodes', 'alsh_saisie_noe', 'alsh_tranches_age'),
    '0029': ('budget_prev_config_codes', 'budget_prev_saisies'),
    '0031': ('demandes_conges',),
    '0033': ('commandes_salaries', 'delegations_missions'),
    '0034': ('prevention_dismissals',),
    '0037': ('journal_acces',),
    '0039': ('journal_actions',),
    '0040': ('cse_membres', 'cse_messages', 'cse_mouvements', 'cse_soldes_initiaux'),
    '0042': ('budget_ps_comptes', 'budget_ps_simulations'),
    '0045': ('budget_paie_simulations',),
    '0047': ('bilan_action_data',),
    '0048': ('delegations_salles_recurrence',),
    '0049': ('planif_blocs', 'planif_recurrences', 'planif_taches'),
    '0052': ('subventions_types',),
    '0054': ('recherche_log',),
    '0056': ('budget_fiches_travail',),
    '0061': ('benevoles_activites', 'benevoles_heures_autres', 'benevoles_participations',
             'benevoles_presences', 'benevoles_seances'),
    '0063': ('delegations_benevoles',),
    '0064': ('fonctions',),
    '0065': ('fiches_versions', 'fiches_evenements', 'fiches_a_recalculer'),
    '0068': ('rh_projections', 'rh_projections_a_verifier', 'paie_a_recalculer'),
